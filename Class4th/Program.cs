...
namespace Class4th
{
    class GameObject
    {
        ...
        private int y; // private : 클래스 내부에서만 클래스의 속성을 접근할 수 있습니다.
        protected int z; // probecter : 클래스 내부와 자기가 상속하고 있는 클래스에서만 접근을 허용할 수 있는 지정자입니다.
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 접근하고 사용할 수 있는 집합계입니다.

            //GameObject gameObjecct; new GameObject();
