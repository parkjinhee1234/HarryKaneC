...
namespace Class1th
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            short shortData = 100;  //  shrot   : 2 byte
            ...
            Console.WriteLine("character 변수의 값 : "  + boolean);
            Console.WriteLine("integer 변수의 값 : "  + boolean);
            Console.WriteLine("health 변수의 값 : "  + boolean);
            Console.WriteLine("attack 변수의 값 : "  + boolean);
